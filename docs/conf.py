...
# documentation.
html_theme_options = {
    "footerbgcolor": "#12659c",
    "sidebarbgcolor": "#12659c",
    "sidebarlinkcolor": "#AEDFFF",
...
htmlhelp_basename = "generate_alchemical_lammps_inputsdoc"
...
latex_documents = [
    (
        master_doc,
        "generate_alchemical_lammps_inputs.tex",
